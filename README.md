...
**[Enumerable]** is a about make connection between class and it's methods
...
```sh
 git clone https://github.com/M-AminAlizadeh/Enumerable
 cd Enumerable
```

### Install

If you install the ruby successfully in the last chapter go to next step
...
Feel free to check the [issues page](https://github.com/M-AminAlizadeh/Enumerable/issues).
